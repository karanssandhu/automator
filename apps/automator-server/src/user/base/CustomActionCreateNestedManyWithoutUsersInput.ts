...
@InputType()
class CustomActionCreateNestedManyWithoutUsersInput {
...
export { CustomActionCreateNestedManyWithoutUsersInput as CustomActionCreateNestedManyWithoutUsersInput };
