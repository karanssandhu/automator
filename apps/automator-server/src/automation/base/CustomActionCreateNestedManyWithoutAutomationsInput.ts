...
@InputType()
class CustomActionCreateNestedManyWithoutAutomationsInput {
...
export { CustomActionCreateNestedManyWithoutAutomationsInput as CustomActionCreateNestedManyWithoutAutomationsInput };
